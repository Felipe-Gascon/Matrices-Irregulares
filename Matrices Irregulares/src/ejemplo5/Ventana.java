...
public class Ventana extends JFrame {
	...
	private String ciudades[]=
		{"Albacete","Alicante","Almeria","Avila","Badajoz","Barcelona","Bilbao","Burgos","Cáceres","Cádiz","Castellón",
			"Ciudad Real","Córdoba","A Coruña","Cuenca","Gerona","Granada","Guadalajara","Huelva","Huesca","Jaen","Leon",
			"Lérida","Logroño","Lugo","Madrid","Málaga","Murcia","Orense","Oviedo","Palencia","Pamplona","Pontevedra","Salamanca",
			"S. Sebastián","Santander","Segovia","Sevilla","Soria","Tarragona","Teruel","Toledo","Valencia","Valladolid","Vitoria","Zamora","Zaragoza"};
